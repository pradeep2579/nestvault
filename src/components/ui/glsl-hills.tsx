...
export function GLSLHills({
          ...
          new THREE.RawShaderMaterial({
            ...
            vertexShader: `
              ...
              void main(void){
                ...
                vec3 lp=p+vec3(0.0,n1*s*8.0+n2*s*8.0+n3*(abs(s)*2.0+0.5)+pow(s,2.0)*40.0,0.0);
                vPosition=lp;
            ...
            fragmentShader: `
              ...
              void main(void){
                float fade=(96.0-length(vPosition))/256.0*${opacity.toFixed(2)};
                gl_FragColor=vec4(${r.toFixed(3)},${g.toFixed(3)},${b.toFixed(3)},max(0.0,fade));
              }
            `,
            transparent: true,
            wireframe: true,
  ...
  }, [cameraZ, planeSize, speed, color, opacity]);

  return (
    <div ref={containerRef} style={{ position: "absolute", inset: 0, width, height, pointerEvents: "none" }}>
